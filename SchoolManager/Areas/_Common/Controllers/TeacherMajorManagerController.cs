...
namespace SchoolManager.Controllers
{
    ...
    [ActionDescription("教师奖惩处理")]
    [ApiController]
    [Route("api/TeacherMajorManager")]
	public partial class TeacherMajorManagerController : BaseApiController
    {
        ...
        [HttpGet("{id}")]
        public TeacherMajorManagerVM Get(string id)
        {
            var vm = Wtm.CreateVM<TeacherMajorManagerVM>(id);
            return vm;
        }

        [ActionDescription("Sys.Create")]
        [HttpPost("Add")]
        public IActionResult Add(TeacherMajorManagerVM vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorJson());
        ...
        [HttpPut("Edit")]
        public IActionResult Edit(TeacherMajorManagerVM vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorJson());
        ...
        {
            var vm = Wtm.CreateVM<TeacherMajorManagerBatchVM>();
        ...
        {
            var vm = Wtm.CreateVM<TeacherMajorManagerImportVM>();
        ...
        [HttpPost("Import")]
        public ActionResult Import(TeacherMajorManagerImportVM vm)
        {
